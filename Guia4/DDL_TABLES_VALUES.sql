...
CREATE TABLE country (
  ...
  Continent varchar(20) NOT NULL CHECK(Continent IN ('Asia','Europe','North America','Africa','Oceania','Antarctica','South America')) DEFAULT 'Asia',
...
CREATE TABLE countrylanguage (
  ...
  IsOfficial char(1) NOT NULL CHECK(IsOfficial IN ('T','F')) DEFAULT 'F',
...
INSERT INTO CountryLanguage VALUES ('ZWE','countryEnglish','T',2.2);
